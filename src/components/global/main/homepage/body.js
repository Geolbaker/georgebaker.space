...
function Body() {
  ...
  return (
    <div
      id="HomepageBody"
      className={`${active === "Home" ? "h-screen" : "h-full"} font-['DM_Serif_Display'] overflow-x-hidden overflow-y-scroll w-screen bg-homepage-bg text-homepage-text transition-all duration-500`}
    >
      {/* Navigation Items */}
      <div
        id="HomepageBody"
        className={`${active === "Home" ? "h-screen" : "h-full"} absolute flex justify-center items-center w-screen transition-all duration-500`}
      >
        <div
          className={`${active === "Home" ? "delay-[0.5s]" : "translate-x-[-80vw] opacity-[0.0001]"} w-max absolute flex-col md:flex-row flex justify-end transition-all duration-500 `}
        >
          <div className="container text-[2rem] w-[15rem]">
            <div
              id="portfolioMain"
              className="link link-underline-25 link-emphasis group opacity-[0.0001] translate-y-[3rem] text-homepage-text"
            >
              Portfolio
          ...
          <div className="container text-[2rem] w-[15rem] h-[10rem] md:h-auto overflow-hidden relative">
            <div
              id="themeSubMenu"
              className="flex flex-col link translate-x-[-20rem] absolute top-0 ml-8"
            >
              <span
                className="relative after:text-[1rem] after:text-homepage-bg after:px-1
                    ...
                    after:w-[17ch] after:h-5 after:rounded-md after:z-20"
              ></span>
              <button
                className="link link-underline-25 link-emphasis text-homepage-text text-left"
                onClick={() => window.open("/#/xp", "_self")}
              >
                Windows XP
              </button>
            </div>
            ...
            >
              ...
              <a
                href="https://www.goodreads.com/geolbaker"
                target="_blank"
                rel="noreferrer"
                className="link link-underline-25 link-emphasis text-homepage-text text-left"
              >
                ...
                <svg
                  ...
                  height="16"
                  fill="currentColor"
                  className="inline font-[900] fill-homepage-text scale-[1.3] left-[12px] bottom-[3px] relative stroke-homepage-text link"
                  viewBox="0 0 16 16"
                >
                  <path
                    fill-rule="evenodd"
      ...
      <div className="bottom-[12vh] right-[200px] flex absolute z-30">
        <div
          id="socialIcons"
          className="fixed flex m-5 transition-all duration-500 opacity-[0.0001]"
        >
          <a
            alt="Personal Codepen"
            href="https://codepen.io/geo1baker"
            target="_blank"
            rel="noreferrer"
            className="p-5"
          >
            <svg
              width="16"
              height="16"
              className="bi bi-code-slash link scale-[200%] hover:scale-[230%] fill-homepage-text"
              viewBox="0 0 16 16"
            >
          ...
          <a
            alt="Personal Github"
            href="https://github.com/Geolbaker"
            target="_blank"
            rel="noreferrer"
            className="p-5"
          >
            <svg
              width="16"
              height="16"
              className="bi bi-github link scale-[200%] hover:scale-[230%] fill-homepage-text"
              viewBox="0 0 16 16"
            >
          ...
          <a
            ...
            href="https://youtube.com/@geolbaker"
            target="_blank"
            rel="noreferrer"
            className="p-5"
          >
            <svg
              width="16"
              height="16"
              className="bi bi-youtube link scale-[200%] hover:scale-[230%] fill-homepage-text"
              viewBox="0 0 16 16"
            >
      ...
      <div className="right-[1vw] top-7 flex absolute px-8 z-30">
        <div
          id="colorPalleteIcon"
          className="fixed transition-all duration-500 opacity-[0.0001]"
        >
          <div
            id="colourPallete"
            className="absolute top-[-7px] left-[-4px] w-[25px] h-[30px] hover:cursor-pointer z-20 peer"
          ></div>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="16"
            height="16"
            className="bi bi-droplet-half scale-[170%] link peer-hover:scale-[200%] fill-homepage-text"
            viewBox="0 0 16 16"
          >
            <path
              fillRule="evenodd"
      ...
      {/*Back Button*/}
      <div
        className={`${active === "Home" ? "translate-x-[-20vw] opacity-[0.0001]" : "translate-x-0 opacity-100"}
      duration-500 transition-all fixed top-16 left-1 sm:left-3 z-30`}
      >
        <button
          className="link link-emphasis fixed left-4 bottom-0 pl-8 text-[1.7rem] text-homepage-text
      ...
      {/*Portfolio Section*/}
      <div
        className={`${active === "Portfolio" ? "translate-y-0 opacity-[100] pt-12 sm:pt-24 h-[20rem]" : "h-[0.0001rem] opacity-[0.0001] translate-y-[100vh] overflow-hidden"} relative top-0 z-10 w-screen flex justify-center transition-all duration-[1s] `}
      >
        <div
          id="portfolioSection"
          className=" transition-all duration-500 opacity-[0.0001] "
        >
          <div className="container flex justify-center items-center flex-col text-homepage-text p-4 sm:p-12 mb-12 sm:mb-4">
            <span
              className="text-[4rem] sm:text-[6rem] lg:text-[9rem] text-center relative after:content-[''] after:top-[3.5rem] sm:after:top-[5.5rem] lg:after:top-[8.5rem] after:left-0 after:w-full after:h-[4rem]
            ...
            <div className="w-full md:w-[90%] h-full gap-8 flex flex-col text-[1.3rem] !font-sans justify-center text-left pb-12 text-homepage-text ">
              ...
              <div className="w-full h-full gap-8 flex pt-2 flex-col text-[2rem] !font-['DM_Serif_Display'] justify-center text-left text-homepage-text ">
                <p className="text-homepage-text">Optima Graphic Design</p>
              </div>
              ...
              <div className="w-full h-full gap-8 flex pt-2 flex-col text-[2rem] !font-['DM_Serif_Display'] justify-center text-left text-homepage-text ">
                <p className="text-homepage-text">SUMS</p>
              </div>
      ...
      {/*Voiceover Section*/}
      <div
        className={`${active === "Voiceover" ? "translate-y-0 opacity-[100] pt-12 sm:pt-24 h-[20rem]" : "h-[0.0001rem] opacity-[0.0001] translate-y-[100vh] overflow-hidden"} relative top-0 z-10 w-screen flex justify-center transition-all duration-[1s] `}
      >
        <div
          id="voiceoverSection"
          className="transition-all duration-500 opacity-[0.0001]"
        >
          <div className="container flex justify-center items-center flex-col text-homepage-text p-4 sm:p-12 mb-12 sm:mb-4">
            ...
            <div className="w-full md:w-[90%] h-full gap-8 flex flex-col text-[1.3rem] !font-sans justify-center text-left pb-12 text-homepage-text">
              {/* Introduction */}
              <div className="w-full flex flex-col gap-4 pt-4 pb-4">
                <p>
                  I began my voiceover work independently, developing it from
                  the ground up. This later evolved into a fully structured
                  in-house production process within my current workplace, while
                  I continue to undertake independent projects alongside it. I
                  have delivered work for clients both internally and
                  independently, ranging from individual productions to
                  international charities. Over the past five years, I have
                  designed and treated recording spaces, selected and configured
                  equipment, and established a repeatable workflow for
                  recording, editing, mastering, and subtitling.
                </p>
                <p>
                  Projects have included charity storytelling, medical
                  explainers, internal corporate training, awards productions,
                  product showcases, independent game development, and social
                  media content — all delivered with full post-production and
                  multilingual subtitle support where required.
                </p>
              </div>

              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2 w-full md:w-1/2">
                <a
                  href="https://www.voices.com/profile/geolbaker"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="block rounded-xl border border-homepage-alt bg-homepage-bg/80 p-4 shadow-sm hover:shadow-md hover:-translate-y-[2px] transition hover:cursor-pointer"
                >
                  <div className="flex flex-col gap-1 hover:cursor-pointer">
                    <span className="text-xs uppercase tracking-[0.15em] opacity-70 hover:cursor-pointer">
                      Profile
                    </span>
                    <span className="text-[1.2rem] !font-['DM_Serif_Display'] hover:cursor-pointer">
                      Voices.com
                    </span>
                  </div>
                </a>
                ...
                <a
                  href="https://voice123.com/voice-actor/george300lbaker"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="block rounded-xl border border-homepage-alt bg-homepage-bg/80 p-4 shadow-sm hover:shadow-md hover:-translate-y-[2px] transition hover:cursor-pointer"
                >
              ...
              <div className="w-full flex flex-col gap-6 pt-6">
                <h3 className="text-[2rem] !font-['DM_Serif_Display']">
                  Client Showcase
                </h3>

                <p>
                  Selected client-facing projects, including medical explainer
                  content and product showcases, delivered with full narration,
                  audio post-production, and subtitling where required.
                </p>

                {/* Mended Hearts Europe */}
                <div className="flex flex-col gap-3 pt-2">
                  <h4 className="text-[1.5rem] !font-['DM_Serif_Display']">
                    Mended Hearts Europe
                  </h4>
                  <p>
                    Ongoing series of medical explainer videos supporting
                    patients and families across Europe.
                  </p>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pt-2">
                    ...
                    <div className="w-full aspect-video rounded-lg overflow-hidden">
                      <iframe
                        ...
                        src="https://www.youtube.com/embed/k64_MM9WgNY"
                        title="Mended Hearts Europe – Medical Explainer 1"
                        frameBorder="0"
                    ...
                    <div className="w-full aspect-video rounded-lg overflow-hidden">
                      <iframe
                        className="w-full h-full"
                        src="https://www.youtube.com/embed/9vwOfQ45Kbw"
                        title="Mended Hearts Europe – Medical Explainer 2"
                        frameBorder="0"
                        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                        referrerPolicy="strict-origin-when-cross-origin"
                        allowFullScreen
                    ...
                    <div className="w-full aspect-video rounded-lg overflow-hidden">
                      <iframe
                        className="w-full h-full"
                        src="https://www.youtube.com/embed/OZE-7JAzxhM"
                        title="Mended Hearts Europe – Medical Explainer 3"
                        frameBorder="0"
                        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                        referrerPolicy="strict-origin-when-cross-origin"
                        allowFullScreen
                ...
                <div className="flex flex-col gap-3 pt-8">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 pt-2">
                    <div className="w-full aspect-video rounded-lg overflow-hidden">
                      <iframe
                        className="w-full h-full"
                        src="https://player.vimeo.com/video/914458716?h=7fcd3cbcc1"
                        title="FIT Commercial Brokers – Product Showcase"
                        frameBorder="0"
                        referrerPolicy="strict-origin-when-cross-origin"
                ...
                {/* Optima Graphic Design / SUMS / Lincoln College */}
                <div className="flex flex-col gap-3 pt-8">
                  <h4 className="text-[1.5rem] !font-['DM_Serif_Display']">
                    Optima Graphic Design / SUMS / Lincoln College
                  </h4>
                  <p>
                    Over 50 hours of internal training, instructional and
                    demonstration content, delivered with full narration and
                    post-production across multiple departments and
                ...
                <div className="flex flex-col gap-3 pt-6">
                  ...
                  <p>Website demonstration and narration.</p>
                </div>
                ...
                <div className="flex flex-col gap-3 pt-6">
                  ...
                  <p>
                    Awards ceremony narration produced for internal event
                    presentation.
                  </p>
                </div>
              </div>
              ...
              <div className="w-full flex flex-col gap-6 pt-8">
                ...
                <div className="flex flex-col gap-4 text-[1.1rem]">
                  <p>
                    Many independent and internal projects are not publicly
                    hosted due to client privacy. Selected independent and demo
                    voiceover samples are available via my professional profiles
                    below:
                  </p>
      ...
      {/*Personal Section*/}
      <div
        className={`${active === "Personal" ? "translate-y-0 opacity-[100] pt-12 sm:pt-24 h-[20rem]" : "h-[0.0001rem] opacity-[0.0001] translate-y-[100vh] overflow-hidden h-0"} relative top-0 z-10 w-screen flex justify-center transition-all duration-[1s] `}
      >
        <div
          id="personalSection"
          className=" transition-all duration-500 opacity-[0.0001] "
        >
          <div className="container flex justify-center items-center flex-col text-homepage-text p-4 sm:p-6 mb-12 sm:mb-4">
            ...
            <div className="w-full md:w-[90%] h-full gap-8 flex pt-4 flex-col text-[1.3rem] !font-sans justify-center text-left pb-12 text-homepage-text ">
              <p className="text-homepage-text">
                I'm George Baker. By day, I'm a web developer, currently
                specialising in Wordpress, Expression Engine and Shopify. By
                night, I'm a fairly tired dad of two, trying to squeeze as much
                out of the day as possible.
              </p>
              <p className="text-homepage-text">
                My spare time is spent tinkering with too many projects that are{" "}
                <span className="!text-[0.8rem]">(finally)</span> starting to
                see the light of day.
              </p>
              <p className="text-homepage-text text-[2rem] !font-['DM_Serif_Display']">
                My Hobbies/Projects:
              </p>
              <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 !text-[1.2rem]">
                <p
                  className="text-homepage-text p-2 pl-6 relative
                 after:content-[''] after:top-[17px] after:left-[3px] after:rounded-[1px] after:h-[8px] after:w-[8px]
                 after:bg-homepage-text after:rotate-[45deg] after:absolute"
                >
              ...
              {/* <p
                ...
                className="text-homepage-text text-[2rem] !font-['DM_Serif_Display'] pt-[45px]"
              >
                Mechanical Keyboards
              </p>
              <p className="text-homepage-text"></p>
      ...
      {/*Personal Section*/}
      <div
        className={`${active === "Documentary" ? "translate-y-0 opacity-[100] pt-12 sm:pt-24 h-[20rem]" : "h-[0.0001rem] opacity-[0.0001] translate-y-[100vh] overflow-hidden h-0"} relative top-0 z-10 w-screen flex justify-center transition-all duration-[1s] `}
      >
        <div
          id="documentarySection"
          className=" transition-all duration-500 opacity-[0.0001] "
        >
          <div className="container flex justify-center items-center flex-col text-homepage-text p-4 sm:p-12 mb-12 sm:mb-4">
            <span
            ...
            <div className="w-full md:w-[90%] h-full gap-8 flex pt-4 flex-col text-[1.3rem] !font-sans justify-center text-left pb-8 text-homepage-text ">
              <p className="text-homepage-text">
                Over the course of a good many months, I filmed footage and
                worked with my good friend Paice Lees to film a documentary
                about my experiences with Rooftopping and Urbex (Urban
                Exploration).
              </p>
            </div>
            <div className="w-full md:w-[75%] h-full gap-8 flex flex-col items-center text-[2rem] justify-center text-center pb-12 text-homepage-text ">
              <iframe
                width="100%"
                height="500px"
                src="https://www.youtube.com/embed/X6_IaHQpMD0"
